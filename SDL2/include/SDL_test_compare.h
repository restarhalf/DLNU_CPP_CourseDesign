 ...
 *
 * \returns 0 if comparison succeeded, >0 (=number of pixels for which the comparison failed) if comparison failed, -1
 * if any of the surfaces were NULL, -2 if the surface sizes differ.
 */
